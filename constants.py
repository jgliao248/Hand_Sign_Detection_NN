...
TRAIN_DATA_FILE_PATH = PROJECT_DIRECTORY + "/" + DATA_DIRECTORY + TRAIN_DATA_FILE
TEST_DATA_FILE_PATH = PROJECT_DIRECTORY + "/" + DATA_DIRECTORY + TEST_DATA_FILE
...
TENSOR_FLOW_MODEL = PROJECT_DIRECTORY + "/" + NETWORK_DIRECTORY + "landmark_model.hdf5"
